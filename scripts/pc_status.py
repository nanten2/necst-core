...
if __name__ == '__main__':
    ...
    cpu = rospy.Publisher('/core/'+name+'/cpu', std_msgs.msg.Float32, queue_size=1, latch=True)
    mem = rospy.Publisher('/core/'+name+'/mem', std_msgs.msg.Float32, queue_size=1, latch=True)
    disk = rospy.Publisher('/core/'+name+'/disk', std_msgs.msg.Float32, queue_size=1, latch=True)
    login = rospy.Publisher('/core/'+name+'/login', std_msgs.msg.Int16, queue_size=1, latch=True)
    proc = rospy.Publisher('/core/'+name+'/proc', std_msgs.msg.Int16, queue_size=1, latch=True)
